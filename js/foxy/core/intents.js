...
const intentMatchers = {
  ...
  compliment: [
  "умница", "классная", "красивая", "ты милая", "милая", "ты супер", "супер", "прелесть", "ты хорошая",
  "лучшая", "обожа", "люблю тебя", "ты класс", "ты чудо", "ты прелесть"
    ],
   joke: ["шутка", "анекдот", "рассмеши", "повесели"],

   weather: ["погода", "дождь", "жара", "солнце", "снег"],

  question: ["можно спросить", "вопрос", "хочу узнать", "расскажи"],
  ...
  promoHint: [
  "уже записана", "я уже записана", "была", "я была", "я записывалась", "отработала", "уже была",
  ...
  "помощь", // ← вот этой строки явно не хватает
],
  points: [
