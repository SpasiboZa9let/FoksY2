...
const intentMatchers = {
  ...
  design: [
    "дизайн", "рисунок", "узор", "пример", "вдохновение", "покажи идеи", "варианты"
  ],
  confirmBooking: [
    "запиши", "хочу записаться", "давай запишемся", "можно записаться", "хочу прийти"
  ],
  showSomething: [
    "покажи", "посмотреть", "что входит", "что есть", "варианты", "что предлагаешь"
  ],
  confirm: [
  ...
  booking: [
    "запись", "забронировать", "где записаться", "как попасть"
  ],
  mood: [
  ...
  softWarning: [
    "заткнись", "заткнись уже", "хватит", "не говори так"
  ],
  styleTalk: [
