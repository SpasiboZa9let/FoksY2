...
const intentMatchers = {
  ...
  showSomething: ["покажи", "посмотреть", "что входит", "что есть", "варианты", "что предлагаешь"],
  confirm: ["да", "ага", "ок", "хорошо", "точно", "давай"],
  ...
  m  mood: [
    ...
    "нюд", "кошачий глаз", "втирка", "блёстки", "глиттер", "сделай красиво"
  ],
  ...
  showServices: ["услуги", "маникюр", "цены", "прайс", "что делаешь"],
    confirm: [
    "да", "ага", "ок", "хорошо", "точно", "давай", "ясно", "понятно"
  ],
  showSomething: [
    "покажи", "посмотреть", "что входит", "что есть", "варианты", "что предлагаешь", "уточни"
  ],
