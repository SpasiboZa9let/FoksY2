...
export const replies = {
  ...
  design: [
  "Держи подборку свежих идей дизайна: <link> 🎨",
  "Вдохновляйся: вот отличный Pinterest-альбом! ✨",
  "Смотри трендовые варианты на этой доске 🌈",
  "Нужен эффект «вау»? Вот коллекция идей 💎"
],
